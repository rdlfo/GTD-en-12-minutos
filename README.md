...
* La lista "Proyectos"
* Contextos
* Contexto para Agenda
* La lista "Algún día/Quizás"
* El Calendario
* Revisión Semanal
...
GTD significa "Getting Things Done" o en español "Resuelve tus Encargos". GTD
es un método de organización para dar seguimiento a tus pendientes.

El objetivo de GTD no es solamente ser una lista de recordatorios, sino
un sistema completo en el que puedas confiar para permitirte avanzar y completar
tus proyectos.

Con el podrás monitorear y completar ideas vagas como "Conquistar el mundo" o
actividades específicas como "Hablar con Katia a las 10:15 a.m. para discutir
sobre nuestro nuevo proyecto millonario".

El supuesto principal del sistema GTD es que nuestro inconsciente es malo para
pensar activamente que es lo que deberíamos estar haciendo. Por ejemplo: si
tienes hambre pero no hay comida en tu casa, posiblemente te darás cuenta muy
tarde que había que hacer despensa.

Todos tenemos muchas actividades en las que debemos y en las que queremos
trabajar pero estas ideas las dejamos anotadas en algún lado y las dejamos
al futuro y al azar.
...
Cuando te acostumbres a usar y confiar en el método GTD empezarás a sentirte
más en control de tu vida. Esto reducirá tu estrés y te conseguirá más tiempo
para relajarte y completar al mismo tiempo tus proyectos.

GTD es tan simple y sencillo que puedes usar lápiz y papel para manejarlo.
...
regularmente. Puedes agregar además un calendario o agenda que te permita
agregar tareas que deben ser cumplidas en una fecha en específico.

## La lista "In"
En esta lista capturar todas las ideas, actividades, preguntas y pendientes
...
Si es tu primera vez en que usas GTD, deberás vaciar aquí todos tus pendientes
y actividades.
...
Para iniciar, necesitas preguntarte si la entrada que estás revisando es
*accionable*. Es decir: ¿puedes hacer algo con el pendiente? Si la respuesta
es *NO* vas a hacer una de las siguientes:
...
hazte la pregunta ¿Cuál es el siguiente paso? Este paso deberá de ser una
acción *_ concreta*.

Por ejemplo: Si tuvieras una actividad marcada como "Terminar el trabajo de
investigación" deberás de convertirla a una más específica cómo "Citar las
...
pierdas tiempo y complétala de una vez. Entre menos pendientes tengas en tu
lista mejor.

Si la tarea fuera más larga, entonces solo queda hacer uno de las siguiente:
...
atenderás en el futuro, idealmente la realizamos lo más pronto posible.
Si decides diferir agrega la tarea en tu lista de "Siguiente". Es normal que la
mayoría de tus tareas las termines añadiendo a esta lista.
...
descripción breve sobre sus detalles, y sobre los resultados que esperas al
final de este.
...
| Regresar libro el libro Programación básica | @biblioteca     |
...
diaria. Como regla de oro: lo importante es poder comprender a primera vista
cuales son sus posibles actividades dependiendo de donde estes y que tengas a la
mano.
...
delegas seguido o trabajar colaborativamente, manejar contextos como "@Javier"
te permitirán identificar las actividades que necesitas discutir cuando los
veas.
...
qué es lo que necesitas hacer en cada fecha.

No confundas actividades que quieres hacer, con las que debes de hacer. Si es
lo primero estas deben de ir en tu lista de "Siguiente".
...
Completarás una actividad del proyecto que tanto quieres, pero olvidarás
agregar una nueva tarea. Olvidarás quitar las siguientes acciones que sabes que
no harás en el futuro cercano por las nuevas circunstancias.
...
cumplirlo deberás bórralo continuar con lo que realmente te es importante.
...
a crear un nuevo Proyecto asegurate que agregues la primer acción
*concreta*.
...
Tu lista *Siguiente* deben de contener tareas específicas y *concretas* para
realizarlas en la primer oportunidad que tengas.
...
tus tareas. Tampoco uses ninguna herramienta que te dificulte o te haga más
difícil tomar acción.

## Herramientas

Hay varias herramientas que puedes usar para facilitar el manejo de tu sistema
...
que la mejor herramienta siempre es aquella que se acomode a lo que tu
necesitas.
...
GTD. Está elaborada para ser corta y concisa.

Si quieres una vista completa de lo que es el método GTD te recomendamos
...
Esta página fue escrita originalmente por Erlend Hamberg y fue traducida y
adaptada por Rodolfo Treviño. Puedes encontrar el sitio original
(aquí)[hamberg.no/gtd/].

Imágenes en este sitio

Esta escrita en Markdown y se utiliza pandoc para generar el HTML. Si te
interesa hablar conmigo puedes encontrarme en (Twitter)[www.twitter.com/rdlf].
